...
<<<<<<< HEAD
	pManager->setSPEED(2);//«∞Ω¯∫ÛÕÀÀŸ∂»”¶∏√≤ª“ª÷¬£¨”–¥˝–ﬁ∏ƒ
=======
	pManager->setSPEED(2);//ÂâçËøõÂêéÈÄÄÈÄüÂ∫¶Â∫îËØ•‰∏ç‰∏ÄËá¥ÔºåÊúâÂæÖ‰øÆÊîπ
>>>>>>> leonnnop/Map
...
<<<<<<< HEAD
	//»±…Ÿ“ª∏ˆ…˙≥…¿‡£¨∏¥÷∆’≥Ã˘ « ≤√¥¿±º¶
=======
	//Áº∫Â∞ë‰∏Ä‰∏™ÁîüÊàêÁ±ªÔºåÂ§çÂà∂Á≤òË¥¥ÊòØ‰ªÄ‰πàËæ£È∏°
>>>>>>> leonnnop/Map
...
<<<<<<< HEAD
		pManager2->setSPEED(1);//«∞Ω¯∫ÛÕÀÀŸ∂»”¶∏√≤ª“ª÷¬£¨”–¥˝–ﬁ∏ƒ
=======
		pManager2->setSPEED(1);//ÂâçËøõÂêéÈÄÄÈÄüÂ∫¶Â∫îËØ•‰∏ç‰∏ÄËá¥ÔºåÊúâÂæÖ‰øÆÊîπ
>>>>>>> leonnnop/Map
...
void GameLayer::update(float dt)
{
	...
	{
		//this->purge();
		//Ëµ¢Âï¶ÔºåÂ∫îËØ•ËΩ¨Âà∞ËÉúÂà©ÁïåÈù¢ÔºåÊàñ‰∏ã‰∏ÄÂÖ≥Êï∞ÊçÆËØªÂèñÁïåÈù¢„ÄÇ
		return;
	}
	...
	{
		//this->purge();
		//Ëæì‰∫ÜÔºåËΩ¨Âà∞Âò≤ËÆΩÁïåÈù¢2333
		return;
	}
...
void GameLayer::setViewPointCenter(Point position)
{
	...
	//‰ΩøÁ≤æÁÅµÂ§Ñ‰∫éÂ±èÂπï‰∏≠ÂøÉÔºåÁßªÂä®Âú∞ÂõæÁõÆÊ†á‰ΩçÁΩÆ
	Point pointB = Point(x, y);
<<<<<<< HEAD
	//log("ƒø±ÍŒª÷√ (%f ,%f) ", pointB.x, pointB.y);

=======
>>>>>>> leonnnop/Map

	//Âú∞ÂõæÁßªÂä®ÂÅèÁßªÈáè
...
{
	//ÈáäÊîæËøòÊ¥ªÁùÄÁöÑÔºåÈò≤Ê≠¢ÂÜÖÂ≠òÊ≥ÑÊºè
